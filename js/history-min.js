...
YAHOO.util.History = (function () {
    ...
    function _getHash() {
        ...
        i = href.indexOf("#");
        return i >= 0 ? ("page="+href.substr(i + 1)) : null;
    }
    ...
    function _checkIframeLoaded() {
        ...
        setInterval(function () {
            ...
            if (newfqstate !== fqstate) {
                ...
                top.location.hash = newHash.substring(5);
                hash = newHash;
    ...
    return {
        ...
        multiNavigate: function (states) {
            ...
            if (YAHOO.env.ua.ie && (typeof document.documentMode === "undefined" || document.documentMode < 8)) {
                ...
                top.location.hash = fqstate.substring(5);
                if (YAHOO.env.ua.webkit) {
        ...
        getBookmarkedState: function (module) {
            ...
            if (idx >= 0) {
                hash = "page="+top.location.href.substr(idx + 1);
                states = hash.split("&");
                for (i = 0, len = states.length; i < len; i++) {
                    tokens = states[i].split("=");
                    if (tokens.length === 2) {
